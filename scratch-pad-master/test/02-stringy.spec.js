...
describe('#stringy', function () {
  ...
  describe('toDashCase', function () {
    it('should return a dash-cased version of the input String', function () {
      ...
      expect(assignment.toDashCase('Should Work With Many Words')).to.equal(
  ...
  describe('concat`', function () {
    it('should return the two input Strings concatenated', function () {
      ...
      expect(assignment.concat('Operation ', 'Spark')).to.equal(
        'Operation Spark'
      );
    });
  });
  ...
  describe('join`', function () {
    it('should return all input Strings concatenated', function () {
      expect(assignment.join('Hello ', 'there, ', 'you ', 'prince!')).to.equal(
        'Hello there, you prince!'
      );
      expect(
        assignment.join('Hello ', 'there, ', 'you ', 'princess!')
      ).to.equal('Hello there, you princess!');
    });
  });
